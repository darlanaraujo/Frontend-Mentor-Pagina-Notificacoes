# Frontend Mentor - Solução de página de notificações

Esta é uma solução para o [desafio da página de notificações no Frontend Mentor](https://www.frontendmentor.io/challenges/notifications-page-DqK5QAmKbC). Os desafios do Frontend Mentor ajudam você a melhorar suas habilidades de codificação através da construção de projetos realistas.
...
- Selecione "Marcar tudo como lido" para alternar o estado visual das notificações não lidas e definir o número de mensagens não lidas como zero
